"""
Complete Blockchain Service Models - On-chain token payments
"""
...
class SmartContractConfig(models.Model):
    """Configuration for deployed smart contracts"""
...
class Certificate(models.Model):
    """NFT certificates issued on blockchain"""
    ...
    # ZK-SNARK proof for privacy-preserving verification
    zk_proof_hash = models.TextField(null=True, blank=True)
    
    # IPFS metadata
    ipfs_metadata_hash = models.CharField(
        max_length=255,
        null=True,
        blank=True,
...
class ApprovalRequest(models.Model):
    """Track ERC20 approval requests for token spending"""
    ...
    # Transaction details (once approved)
    transaction_hash = models.CharField(max_length=255, unique=True, null=True, blank=True)
...
class WebhookLog(models.Model):
    """Log of blockchain events for debugging and auditing"""
