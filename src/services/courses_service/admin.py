"""
Django admin configuration for courses service
"""
...
class CourseAdmin(admin.ModelAdmin):
    list_display = ['title', 'category', 'instructor', 'access_type', 'status', 'total_enrollments']
    list_filter = ['status', 'access_type', 'category', 'created_at']
    search_fields = ['title', 'description']
    prepopulated_fields = {'slug': ('title',)}
    readonly_fields = ['total_enrollments', 'average_rating', 'total_ratings', 'created_at', 'updated_at']
