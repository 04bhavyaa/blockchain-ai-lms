...
class LessonProgressSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'blockchain_event_tx_hash', 'last_blockchain_status'
        ]
        read_only_fields = ['id', 'started_at', 'completed_at', 'blockchain_event_tx_hash', 'last_blockchain_status']
...
class QuizAttemptSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'time_spent_minutes', 'tokens_earned', 'started_at', 'completed_at',
            'question_responses', 'blockchain_event_tx_hash', 'last_blockchain_status'
        ]
        read_only_fields = [
...
class ModuleProgressSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'started_at', 'completed_at', 'blockchain_event_tx_hash', 'last_blockchain_status', 'updated_at'
        ]
...
class CourseProgressSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'certificate_issued', 'certificate_issued_at', 'enrolled_at',
            'started_at', 'completed_at', 'blockchain_event_tx_hash', 'last_blockchain_status', 'updated_at'
        ]
        read_only_fields = fields
...
class ProgressSnapshotSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'snapshot_date', 'blockchain_event_tx_hash', 'last_blockchain_status'
        ]
        read_only_fields = ['id', 'snapshot_date', 'blockchain_event_tx_hash', 'last_blockchain_status']
